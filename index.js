angular.module('twitterFilters', ['ngSanitize'])
	...
	.filter('tweet', function() {
		return function(text) {
			...
			text = text.replace(urlRegex," <a href='$&'>$&</a>").trim();
			text = text.replace(twitterUserRegex,"<a href='http://www.twitter.com/$1'>@$1</a>");
			text = text.replace(twitterHashTagRegex,"<a href='http://twitter.com/search/%23$1'>#$1</a>");
